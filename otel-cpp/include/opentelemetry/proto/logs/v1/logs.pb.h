...
inline void LogRecord::set_event_name(const std::string& value) {
...
inline void LogRecord::set_event_name(std::string&& value) {
  
  event_name_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:opentelemetry.proto.logs.v1.LogRecord.event_name)
}
inline void LogRecord::set_event_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  event_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:opentelemetry.proto.logs.v1.LogRecord.event_name)
}
inline void LogRecord::set_event_name(const char* value,
    size_t size) {
  ...
  event_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:opentelemetry.proto.logs.v1.LogRecord.event_name)
}
...
inline std::string* LogRecord::unsafe_arena_release_event_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:opentelemetry.proto.logs.v1.LogRecord.event_name)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return event_name_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void LogRecord::unsafe_arena_set_allocated_event_name(
    std::string* event_name) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (event_name != nullptr) {
  ...
  event_name_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      event_name, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:opentelemetry.proto.logs.v1.LogRecord.event_name)
}
