...
enum SpanFlags : int {
  ...
  SpanFlags_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  SpanFlags_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 Span_Link::_internal_flags() const {
  return flags_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 Span_Link::flags() const {
  // @@protoc_insertion_point(field_get:opentelemetry.proto.trace.v1.Span.Link.flags)
  return _internal_flags();
}
inline void Span_Link::_internal_set_flags(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  flags_ = value;
}
inline void Span_Link::set_flags(::PROTOBUF_NAMESPACE_ID::uint32 value) {
