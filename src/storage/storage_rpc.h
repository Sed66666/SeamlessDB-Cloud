...
public:
  StoragePoolImpl(DiskManager *disk_manager, LogStore *log_store,
  ...
  virtual void
  GetLatestPage(::google::protobuf::RpcController *controller,
                const ::storage_service::GetLatestPageRequest *request,
                ::storage_service::GetLatestPageResponse *response,
                ::google::protobuf::Closure *done);

  virtual void
  GetPersistLsn(::google::protobuf::RpcController *controller,
...
private:
  ...
  unsigned char span_id_[8];
  unsigned char trace_id_[16];
};
} // namespace storage_service