...
public:
  // used for sequential scan, the rid_ is initiated as leaf_begin, and the end_
  // is initiated as leaf_end
  ...
  bool is_end() {
    if (rid_.page_no == end_.page_no && rid_.slot_no == end_.slot_no)
      return true;
    return false;
  }
